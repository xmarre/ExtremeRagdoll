...
$build=@(@{Path=(Join-Path $root 'buildchunks/p00.b64');Hash='6f203284f4947192aedcaeed091025512ece5f39c3b5887b27a30e01377150ae'})
...
Join-Chunks $build (Join-Path $root 'build.gz.b64') '6f203284f4947192aedcaeed091025512ece5f39c3b5887b27a30e01377150ae'
Expand-GzipBase64 (Join-Path $root 'build.gz.b64') (Join-Path $root 'build-ga1113-camera-split-crash.ps1') 'ac94227ce84c485797ad3f5dbba21d352e1ef9903343ea315d844b3ffeff10c5' '8942e1cb60b905cf9a5c568bbe6f815b081498ed361d719b5e3fa06a647a26ca'
